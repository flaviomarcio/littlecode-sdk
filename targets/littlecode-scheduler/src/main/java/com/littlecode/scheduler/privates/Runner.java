...
public class Runner implements Runnable {
    ...
    public static void start(Factory factory) {
        ...
        var beanNames = factory.getBeanNames(Schedule.class);
        ...
        beanNames.forEach(
                beanName ->
                {
                    try {
                        ...
                        Object schedulerInstance = factory.getBean(Object.class);
    ...
    public boolean schedulesMaker() {
        ...
        methods.forEach(
                method ->
                {
                    Schedule methodAnnotation = AnnotationUtils.findAnnotation(method, Schedule.class).orElse(null);
                    ...
                    String expression =
                            Util.isNull(methodAnnotation.expression())
