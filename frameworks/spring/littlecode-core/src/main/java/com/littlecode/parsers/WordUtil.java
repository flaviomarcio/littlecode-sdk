...
public class WordUtil {
    ...
    public static WordUtil target(String target) {
        return WordUtil.builder().target(target).build();
    }
    ...
    @Deprecated(since = "use StringUtil.toLeftPad")
    public static String padLeft(int length, char padChar, String value) {
        return StringUtil.toLeftPad(length, String.valueOf(padChar), value);
    }

    @Deprecated(since = "use StringUtil.toRightPad")
    public static String padRight(int length, char padChar, String value) {
        return StringUtil.toRightPad(length, String.valueOf(padChar), value);
    }

    @Deprecated(since = "use StringUtil.toCenterPad")
    public static String padCenter(int length, char padChar, String value) {
        return StringUtil.toCenterPad(length, String.valueOf(padChar), value);
    }
