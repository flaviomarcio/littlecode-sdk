...
public class UrlHelper {
    ...
    private static final List<String> TRUSTED_URLS = List.of("/safe/**", "/oauth/**", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html");
    private static final List<String> TRUSTED_URLS_OPEN = List.of("/safe/**", "/oauth/login/**", "/swagger-ui/**", "/v3/api-docs/**", "/actuator/**", "/prometheus/**");
